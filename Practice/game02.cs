...
namespace Unity11 // 24.8.19
{
    public class Item
    {
        ...
        public int Id { get => id; set => id = value; }   // 속성     //get : Id가 얻어오는 값     //set : Id가 값을 변경할 때 사용합니다.
        public string Name { get => name; set => name = value; }     //value : 수정할 값
    ...
    internal class game02
    {
        static void Main(string[] args)
        {
            ...
            //레퍼런스(reference) = 객체
            //                      값이 아닌 주소를 가지고있어 컴파일 시점에 크기를 알 수 없습니다.

            //클래스명 레퍼런스명 = new Item();
            Item item = new Item();
            Console.WriteLine(item.Id);
            item.Id = 1;     // 속성을 활용해 변수처럼 속성이 표현하고 있는 값을 수정 할 수 있습니다.
            item.Name = "초코우유";
            Console.WriteLine(item.Id);
